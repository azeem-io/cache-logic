<svg class="absolute opacity-90 top-0 w-full h-auto" viewBox="0 0 1440 1440" fill="none" xmlns="http://www.w3.org/2000/svg">
    <mask id="mask0_7_424" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="1440" height="1440">
    <rect width="1440" height="1440" fill="url(#paint0_radial_7_424)"/>
    </mask>
    <g mask="url(#mask0_7_424)">
    ...
    <defs>
    <radialGradient id="paint0_radial_7_424" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(720 -0.000171661) rotate(90) scale(1440 751.588)">
    <stop/>
